...
type CorpusAcceptanceLabelRecordingSummary struct {
	...
	SourceCount                    int                             `json:"source_count"`
	SeedMode                       bool                            `json:"seed_mode"`
	SeedPrivateMapStatus           string                          `json:"seed_private_map_status"`
	OriginalCorpusCompatible       bool                            `json:"original_corpus_compatible"`
	TranslatedSourceCount          int                             `json:"translated_source_count"`
	TranslatedExpectedOutcomeCount int                             `json:"translated_expected_outcome_count"`
	TranslatedEvidenceRefCount     int                             `json:"translated_evidence_ref_count"`
	ArtifactConfidentiality        string                          `json:"artifact_confidentiality"`
	HeldOutReady                   bool                            `json:"held_out_ready"`
