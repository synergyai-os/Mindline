...
var requiredWP48Groups = []WP48Group{
	...
	{ID: "wp48_lifecycle_rollback", Phase: "pre_live", DependsOn: []string{"wp48_resourcepipeline", "wp48_cli", "wp48_founderreview", "wp48_recallfixture"}, Tool: "go", Argv: []string{"test", "./internal/assurance", "./internal/recallproof", "./internal/repositorysnapshot", "./internal/recalleval", "./internal/founderreview", "./internal/localservice", "./cmd/mindline-agent-build", "./cmd/mindline-recall-eval"}, Shell: false},
	{ID: "wp48_race", Phase: "pre_live", DependsOn: []string{"wp48_lifecycle_rollback"}, Tool: "go", Argv: []string{"test", "-race", "./internal/ingestioncontroller", "./internal/resourcefetch", "./internal/resourcequeue", "./internal/resourcepipeline", "./internal/personalmemory", "./internal/localservice", "./internal/agentstate", "./internal/recallfixture", "./internal/recalleval", "./internal/recallproof", "./internal/repositorysnapshot", "./internal/founderreview"}, Shell: false},
