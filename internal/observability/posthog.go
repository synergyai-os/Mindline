...
var allowedProperties = map[string]bool{
	...
	"$ai_evaluation_name":                true,
	"$ai_evaluation_result":              true,
	"$ai_evaluation_reasoning":           true,
	"threshold":                          true,
	"accuracy":                           true,
	"held_out":                           true,
	"comparable":                         true,
	"url_mention_count":                  true,
	"unique_url_count":                   true,
	"accounted_url_count":                true,
	"requestable_count":                  true,
	"already_artifacted_count":           true,
	"unsupported_count":                  true,
	"blocked_private_or_secret_count":    true,
	"blocked_by_policy_count":            true,
	"supplied_artifact_count":            true,
	"matched_artifact_count":             true,
	"stale_artifact_count":               true,
	"non_generalizable_runtime":          true,
	"url_accounting_coverage":            true,
	"artifact_match_coverage":            true,
	"baseline_needs_enrichment_count":    true,
	"enriched_needs_enrichment_count":    true,
	"baseline_missing_link_count":        true,
	"enriched_missing_link_count":        true,
	"missing_link_reduction_ratio":       true,
	"needs_enrichment_reduction_ratio":   true,
	"safety_hosted_inference_calls":      true,
	"safety_hosted_telemetry_exports":    true,
	"safety_network_fetches":             true,
