...
var requiredWP48Groups = []WP48Group{
	...
	{ID: "wp48_lifecycle_rollback", Phase: "pre_live", DependsOn: []string{"wp48_resourcepipeline", "wp48_cli", "wp48_founderreview", "wp48_recallfixture"}, Tool: "go", Argv: []string{"test", "./internal/recallproof", "./internal/recalleval", "./internal/founderreview", "./internal/localservice", "./cmd/mindline-recall-eval"}, Shell: false},
	...
	{ID: "wp48_private_scanner", Phase: "pre_live", DependsOn: []string{"wp48_diff"}, Tool: "go", Argv: []string{"test", "./internal/assurance", "./internal/recallproof", "./internal/cli", "-run", "Privacy|Private|Structural"}, Shell: false},
